public class String_Array {
    ...
    public static void main(String[] args) {
        ...
        int lengthSuperHero = superheroes.length;
        System.out.println("Total superheroes names in String array: " + lengthSuperHero);

        int lengthYearArray = superheroes.length;
        System.out.println("Total superheroes introduction year in int array: " + lengthYearArray);
